...
def cal_scale(bandwidth, base_bandwidth, block_size, propagation_delay):
    base_delay = (block_size*1024*8)/(base_bandwidth*1000000) + propagation_delay

    delay = (block_size*1024*8)/(bandwidth*1000000) + propagation_delay
    scale = base_delay / delay
    return scale
...
def cal_targets():
    ...
    base_bandwidth = 5
    base_diff = "0x0000007fffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
