...
avai_size = prop_size
shard_num = 1
avai_hex = "000003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
alpha = 0.67
alpha_var = 0.42
lambda_p = 0.18
...
tx_hex = f"{tx_num:0{len(avai_hex)}x}"
prop_hex = f"{prop_num:0{len(avai_hex)}x}"
in_avai_hex = f"{in_avai_num:0{len(tx_hex)}x}"
manifoldchain_in_hex = f"{manifoldchain_in_num:0{len(avai_hex)}x}"
manifoldchain_ex_hex = f"{manifoldchain_ex_num:0{len(avai_hex)}x}"
